...
{"<div style='position:fixed;top:16px;right:24px;z-index:200;pointer-events:none;'><img src='data:image/png;base64," + logo_b64 + "' style='height:52px;filter:drop-shadow(0 2px 8px rgba(0,210,255,0.25));' alt='BRINC'></div>" if logo_b64 else ""}
...
<footer class="doc-footer">
  ...
  <span>{"<img src='data:image/png;base64," + logo_b64 + "' style='height:24px;'>" if logo_b64 else ""} BRINC Drones, Inc. · <a href="https://brincdrones.com">brincdrones.com</a> · <a href="mailto:sales@brincdrones.com">sales@brincdrones.com</a> · +1 (855) 950-0226</span>

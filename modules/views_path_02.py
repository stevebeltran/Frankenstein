"""Path 02 — Upload CAD Incident Files UI and processing."""
import json
import time
import traceback
...
from modules.config import STATE_FIPS, US_STATES_ABBR, get_jurisdiction_message
...
from modules.utilities import (
    get_themed_logo_base64, get_transparent_product_base64,
    find_jurisdictions_by_coordinates, _select_best_boundary_for_calls,
    save_boundary_gdf, _make_random_stations, _refresh_reference_population,
    _write_crash_report, _notify_crash_email, _uploaded_files_signature, _reset_census_state,
)


def render():
    """Render Path 02 UI: Upload CAD Incident Files."""
st.markdown(f"""
